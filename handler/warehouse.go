...
func (h *WarehouseHandler) CreateWarehouse(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.service.CreateNewWarehouse(newWarehouse); err != nil {
...
func (h *WarehouseHandler) List(w http.ResponseWriter, r *http.Request) {
	...
	warehouses, pagination, err := h.service.GetAllWarehouses(page, limit)
	if err != nil {
...
func (h *WarehouseHandler) GetById(w http.ResponseWriter, r *http.Request) {
	...
	warehouse, err := h.service.GetById(warehouseId)
	if err != nil {
		utils.ResponseFailed(w, http.StatusBadRequest, "cant find warehouse", err)
		return
	}
